...
namespace PetGrooming.Controllers
{
    public class PetController : Controller
    {
        ...
        public ActionResult Update(int id,string PetName, string PetColor, double PetWeight, int SpeciesID)
        {
            ...
            string query = "UPDATE Pets SET PetName = @PetName, SpeciesID = @SpeciesID, color = @PetColor, Weight = @PetWeight WHERE PetID = @id";
            ...
            sqlparams[2] = new SqlParameter("@PetColor", PetColor);
            sqlparams[3] = new SqlParameter("@PetWeight", PetWeight);
